...
public class CharStreamTask2 {
    public static void main(String[] args) {
        ...
        try (FileReader readFrom = new FileReader(path.toFile());
...
// copy List of reservedJavaFile's chars List to []
            ...
            for (Map.Entry entry :
                ...
                s.append(entry.getKey() + " содержится в файле " + path.getFileName() + " " + entry.getValue() +
                        " раз.");
            }
